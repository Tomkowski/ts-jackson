...
var Playlist = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, index_1.JsonProperty)('images[2]'),
        __metadata("design:type", image_1.Image)
    ], Playlist.prototype, "icon", void 0);
    __decorate([
        (0, index_1.JsonProperty)('images[0]'),
        __metadata("design:type", image_1.Image)
    ], Playlist.prototype, "backgroundImage", void 0);
    __decorate([
        (0, index_1.JsonProperty)({ required: true, path: 'tracks.items', elementType: track_1.Track }),

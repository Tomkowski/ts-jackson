...
var Token = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, index_1.JsonProperty)({ path: 'access_token', required: true }),
        __metadata("design:type", String)
    ], Token.prototype, "accessToken", void 0);
    __decorate([
        (0, index_1.JsonProperty)({ path: 'refresh_token', required: true }),
        __metadata("design:type", String)
    ], Token.prototype, "refreshToken", void 0);
    __decorate([
        (0, index_1.JsonProperty)({ path: 'token_type', required: true }),
        __metadata("design:type", String)
    ], Token.prototype, "tokenType", void 0);
    __decorate([
        (0, index_1.JsonProperty)({ path: 'expires_in', required: true }),
